...
function createSteamStyleButton(text, iconType, clickHandler) {
    ...
    if (iconType === 'search') {
        ...
        const path1 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        path1.setAttribute('d', 'M7 12.5C10.0376 12.5 12.5 10.0376 12.5 7C12.5 3.96243 10.0376 1.5 7 1.5C3.96243 1.5 1.5 3.96243 1.5 7C1.5 10.0376 3.96243 12.5 7 12.5Z');
        path1.setAttribute('stroke', 'white');
        path1.setAttribute('stroke-width', '1.5');
        
        const path2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        path2.setAttribute('d', 'M5 5L9 9M9 5L5 9');
